    ...
    def __init__(self, public_key: str, secret_key: str, testnet: bool, futures: bool):
        ...
        if self.futures:
            ...
            if testnet:
                ...
                self._public_key = os.environ.get('BINANCE_PUBLIC_KEY')
            ...
            if testnet:
                ...
                self._public_key = os.environ.get('BINANCE_TESTNET_SPOT_PUBLIC_KEY')
                self._secret_key = os.environ.get('BINANCE_TESTNET_SPOT_SECRET_KEY')
            else:
                self._base_url = "https://api.binance.com"
                self._wss_url = "wws://stream.binance.com:9443/ws"
                self._public_key = os.environ.get('BINANCE_SPOT_PUBLIC_KEY')
                self._secret_key = os.environ.get('BINANCE_SPOT_PUBLIC_KEY')
